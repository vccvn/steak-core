...
abstract class Mask implements Countable, ArrayAccess, IteratorAggregate, JsonSerializable, Jsonable, Arrayable
{
     ...
     *
     * @param \Illuminate\Support\Collection|\Steak\Models\Model $relation
     * @param string $mask
     * @return Mask|MaskCollection|\Illuminate\Support\Collection|\Steak\Models\Model
     */
     ...
     * @return Mask|MaskCollection|\Illuminate\Support\Collection|\Steak\Models\Model|null
     */
