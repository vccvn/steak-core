...
use Steak\Core\asks\Mask;
use Steak\Core\Masks\MaskCollection;
use Steak\Core\Magic\Arr;
use Steak\Core\Masks\ExampleCollection;
use Steak\Core\odels\Model;
use Steak\Core\odels\MongoModel;
use Steak\Core\odels\SQLModel;
...
trait FilterAction
{
     ...
     * @var string
     */
    protected $maskNamespace = 'Steak\Core\asks';
     ...
     * @param array $args
     * 
     * @return \Steak\Core\asks\MaskCollection
     */
     ...
     * @return \Steak\Core\asks\MaskCollectionExamples
     */
